...
(function() {
  ...
  function actualScript() {
    var macros = {};
    macros[82] = {"message": "Powerups are spawning soon!", "toAll": false}; // R
    macros[70] = {"message": "mb", "toAll": false}; // F
    macros[86] = {"message": "nw", "toAll": false}; // V
    macros[81] = {"message": "Enemy FC is top-left!", "toAll": false}; // Q
    macros[87] = {"message": "Enemy FC is top!", "toAll": false}; // W
    macros[69] = {"message": "Enemy FC is top-right!", "toAll": false}; // E
    macros[65] = {"message": "Enemy FC is left!", "toAll": false}; // A
    macros[83] = {"message": "Enemy FC is middle!", "toAll": false}; // S
    macros[68] = {"message": "Enemy FC is right!", "toAll": false}; // D
    macros[90] = {"message": "Enemy FC is bottom-left!", "toAll": false}; // Z
    macros[88] = {"message": "Enemy FC is bottom!", "toAll": false}; // X
    macros[67] = {"message": "Enemy FC is bottom-right!", "toAll": false}; // C
