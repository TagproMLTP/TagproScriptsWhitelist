...
tagpro.ready(function() {
    ...
    var texture = PIXI.Texture.fromImage('https://i.imgur.com/N3A32mA.png'),
    ...
    tagpro.renderer.createSpin = function(player) {
        ...
        if (!player.sprites.marble) {
            ...
            player.sprites.marble.alpha = 1; ////////////////////////////////////////////////////////////////og 0.6
    ...
    tagpro.renderer.createBallSprite = function (player) {
        ...
        player.sprites.actualBall = tagpro.tiles.draw(player.sprites.ball, texture, {x: 0, y: 0}, null, null, 0.65); ////////////////// og .5
    ...
    tagpro.renderer.updateRollingBomb = function (player) {
        if (player.bomb) {
            if (!player.sprites.bomb) {
                ...
                player.sprites.bomb.alpha = Math.abs(0.6 * Math.sin(performance.now() / 50)); //og 150//////////////////////////////////////////
            }
        } else {
            if (player.sprites.bomb) {
