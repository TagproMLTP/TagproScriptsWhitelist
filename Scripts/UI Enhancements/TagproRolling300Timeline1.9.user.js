...
// @version         1.9.0
//                   • Improved Pie Graphs (using chart.js)
//                   • Made code more efficient & compliant
//                   • Changed Games/Day Graph
...
function setTimelineCellHeights(Cell_Width) {
    ...
    $('#R300_Timeline').find('.r300_win').css     ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.Win_Color.value,     'height':'10px', 'width':Cell_Width+'px' });
    $('#R300_Timeline').find('.r300_loss').css    ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.Loss_Color.value,    'height':'10px', 'width':Cell_Width+'px' });
    $('#R300_Timeline').find('.r300_dc').css      ({ 'display':'inline-block', 'cursor':'pointer', 'margin'     :'0px 0px 2px '+(R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.DC_Color.value,      'height':' 6px', 'width':Cell_Width+'px' });
    $('#R300_Timeline').find('.r300_ssa').css     ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.SSA_Color.value,     'height':' 7px', 'width':Cell_Width+'px', 'border-top':'3px solid white' });
    $('#R300_Timeline').find('.r300_fsa').css     ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.FSA_Color.value,     'height':' 7px', 'width':Cell_Width+'px', 'border-bottom':'3px solid white' });
    $('#R300_Timeline').find('.r300_tie').css     ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.Tie_Color.value,     'height':'10px', 'width':Cell_Width+'px' });
    $('#R300_Timeline').find('.r300_unknown').css ({ 'display':'inline-block', 'cursor':'pointer', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? 1 : 0)+'px', 'background-color':R300_Selections.Unknown_Color.value, 'height':'10px', 'width':Cell_Width+'px' });
}
...
function showData() {
    ...
    $('#R300_Pie').append('<canvas id="gamesPieChart" width="80" height="80" style="margin:0 50px"></canvas>');
    var ctx = $("#gamesPieChart").get(0).getContext("2d");
    ...
    var gamesPieDataSets = [
        {value: gamesPieData[0],
         color: R300_Selections.Win_Color.value,
         highlight: '#67ff67',
         label: 'Win'
        },
        {value: gamesPieData[1],
         color: R300_Selections.Loss_Color.value,
         highlight: '#ff4343',
         label: 'Loss'
        },
        {value: gamesPieData[2],
         color: R300_Selections.Tie_Color.value,
         highlight: '#ffcc7b',
         label: 'Tie'
        },
        {value: gamesPieData[3],
         color: R300_Selections.DC_Color.value,
         highlight: '#fffe8d',
         label: 'DC'
        },
        {value: gamesPieData[4],
         color: R300_Selections.FSA_Color.value,
         highlight: '#51c6e7',
         label: 'USA'
        },
        {value: gamesPieData[5],
         color: R300_Selections.SSA_Color.value,
         highlight: '#88e888',
         label: 'SSA'
        }
    ];
    ...
    $R300_Messages.append('<div id="R300_GamesPerDayGraph" style="display:flex; align-items:baseline; width:'+(dayCounts.length*(gamesperday_barwidth+(dayCounts.length < 200 ? 1 : 0)))+'px; max-width:420px; margin:0 auto; border-bottom:1px solid #fff"></div>');
    var $R300_GamesPerDayGraph = $('#R300_GamesPerDayGraph');
    $.each(dayCounts, function(key, value) {
        i = (value.win+value.loss+value.dc+value.ssa+value.fsa+value.tie);
        totalTimePlayed += dayCounts[key].timePlayed;
        $R300_GamesPerDayGraph.append('<div id="gamesperday_bar_'+key+'" class="gamesperday_bar" data-firstgame="'+(data.length-value.firstGameNumber)+'" data-gamecount="'+i+'" style="height:'+scaleBetween(i, (i?2:0), 30, minPlays, maxPlays)+'px; width:'+gamesperday_barwidth+'px" title="'+i+' Games on ' + dayCounts[key].day + " (" + secondsToHMS(dayCounts[key].timePlayed) + " played)\n"+value.win+' Wins, '+ value.loss+' Losses, '+ value.tie +' Ties,'+ value.dc+' DCs, '+ value.ssa+' Saves, '+ value.fsa+' USAs"></div>');
        $('#gamesperday_bar_'+key).append('<div style="position:absolute; background:'+R300_Selections.Win_Color.value+'; bottom:0px; width:'+gamesperday_barwidth+'px; height:'+scaleBetween(value.win+value.ssa, (value.win+value.ssa?2:0), 30, minPlays, maxPlays)+'px"></div>');
    });
    ...
    $('#R300_GamesPerDayGraph').find('.gamesperday_bar').on('click', function() {
...
function showTrimmedData(start, count) {
    ...
    $('#R300T_Timeline').find('.r300t_win').css     ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.Win_Color.value,     'height':'6px', 'width':Cell_Width+'px' });
    $('#R300T_Timeline').find('.r300t_loss').css    ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.Loss_Color.value,    'height':'6px', 'width':Cell_Width+'px' });
    $('#R300T_Timeline').find('.r300t_dc').css      ({ 'display':'inline-block', 'margin'     :'0px 0px 1px '+(R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.DC_Color.value,      'height':'4px', 'width':Cell_Width+'px' });
    $('#R300T_Timeline').find('.r300t_ssa').css     ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.SSA_Color.value,     'height':'4px', 'width':Cell_Width+'px', 'border-top'   :'2px solid white' });
    $('#R300T_Timeline').find('.r300t_fsa').css     ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.FSA_Color.value,     'height':'4px', 'width':Cell_Width+'px', 'border-bottom':'2px solid white' });
    $('#R300T_Timeline').find('.r300t_tie').css     ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.Tie_Color.value,     'height':'6px', 'width':Cell_Width+'px' });
    $('#R300T_Timeline').find('.r300t_unknown').css ({ 'display':'inline-block', 'margin-left':               (R300_Selections.ShowR300ShowGap.value ? ShowGapMarginLeft : 0)+'px', 'background-color':R300_Selections.Unknown_Color.value, 'height':'6px', 'width':Cell_Width+'px' });
    ...
    if (R300_Selections.ShowR300TrimmedGamesPieChart.value) {
        ...
        $('#R300T_Pie').append('<canvas id="gamesPieChartTrimmed" width="50" height="50" style="margin:0 50px"></canvas>');
        var canvas = document.getElementById("gamesPieChartTrimmed");
        var ctx = $("#gamesPieChartTrimmed").get(0).getContext("2d");
...
if ($('#R300').length) {
    ...
    var $R300_Timeline = $('#R300_Timeline');
    ...
    var $R300_Messages = $('#R300_Messages');
    ...
    var $R300T_Timeline = $('#R300T_Timeline');
    $('#R300_Trimmed').append('<div id="R300T_Messages"></div>');
    var $R300T_Messages = $('#R300T_Messages');
}
