...
function load_WLT_Data() {
    ...
    if ( jQuery.type(WLT_Data[0]) !== 'undefined' ) {
        ...
        if ( (WLT_Data[WLT_Data.length-1].result == 'L') && (last_loss_streak >= GM_getValue('WLT_BestLossStreak'))  && (WLT_Data.length > 5) ) {
            $('#WLT').append('<div id="WLT_WorstStreakMessage" style="text-align:center; color:' + Loss_Color + '; padding:5px 0 0; text-shadow:2px 1px 2px #000000">You are currently on your worst ever losing streak :(</div>');
        } else if ( (WLT_Data[WLT_Data.length-1].result == 'L') && (last_loss_streak == GM_getValue('WLT_BestLossStreak') - 1)  && (WLT_Data.length > 5) ) {
            $('#WLT').append('<div id="WLT_WorstStreakMessage" style="text-align:center; color:' + Loss_Color + '; padding:5px 0 0; text-shadow:2px 1px 2px #000000">You are only <u>1 loss away</u> from your <u>worst ever</u> losing streak!</div>');
        }
