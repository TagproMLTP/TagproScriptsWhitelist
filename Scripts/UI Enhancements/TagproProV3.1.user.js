...
// @license       2015
// @author        CFlakes, SomeBall -1, Jackals
// @namespace     http://www.reddit.com/user/jackals4
// ==/UserScript==

$('#tiles')[0].src = 'http://i.imgur.com/ruuWt6h.png';
$('#speedpad')[0].src = 'http://i.imgur.com/JjtKntV.png';
$('#speedpadred')[0].src = 'http://i.imgur.com/mnypcZZ.png';
$('#speedpadblue')[0].src = 'http://i.imgur.com/P4fOZv6.png';
$('#portal')[0].src = 'http://i.imgur.com/EENUi1J.png';
$('#splats')[0].src = 'http://i.imgur.com/uUGIDZl.png';

tagpro.ready(function() {
    var texture = PIXI.Texture.fromImage('http://i.imgur.com/226tzSE.png'),
    ...
    tagpro.renderer.createSpin = function(player) {
        ...
        if (!player.sprites.marble) {
            ...
            player.sprites.marble.alpha = 0.6;
