...
(function() {
  ...
  function actualScript() {
    var macros = {};
    macros[65] = {"message": "opponents fc is left", "toAll": false}; // A
    macros[67] = {"message": "return for cap", "toAll": false}; // C
    macros[68] = {"message": "opponents fc is right", "toAll": false}; // D
    ...
    macros[87] = {"message": "opponents fc is top", "toAll": false}; // W
    macros[88] = {"message": "opponents fc is bot", "toAll": false}; // X
